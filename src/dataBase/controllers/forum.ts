...
class Controller {
  getForums = (_req: any, res: Response) => {
    ForumModel.findAll({
      include: [
        {
          model: TopicModel,
  ...
  getTopicById = (req: any, res: Response) => {
  ...
  getForumById = (req: any, res: Response) => {
  ...
  createTopic = (req: any, res: Response) => {
  ...
  createMessage = async (req: MessageRequestController, res: Response) => {
    const {
      text,
      author,
      topicId,
  ...
  updateMessage = (_req: MessageRequestController, res: Response) => {
    const { id } = _req.body
...
const ControllerForum = new Controller()
